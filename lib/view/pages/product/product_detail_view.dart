...
class ProductDetailView extends StatelessWidget {
  final int productId;
  ProductDetailView({super.key, required this.productId});
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [Text('CGST: '), Text('${p.cgst ?? 0}%')]),
                      const SizedBox(height: 6),
                      Row(children: [Text('SGST: '), Text('${p.sgst ?? 0}%')]),
                      const SizedBox(height: 6),
                      Row(
                        children: [
                          Text('Internal Price: '),
                          Text('₹${p.internalPrice ?? 0}'),
                        ],
                      ),
                      const SizedBox(height: 6),
                      Row(
